    ...
    return (
        <div className='intro-container vert'>
            ...
            <p className='blurb bottom'>
                ...
                this menu, click on a resource in the Student eBook link for
                Unit 1. This will ensure that you have an active session on Ed
                before you begin clicking on Grammar Resources.
            </p>
        </div>
    );
};
